...
export default function App() {
  return (
    <Wrapper>
      <Spline
        className="spline"
        scene="https://prod.spline.design/uwuUwHMehMFVJrBP/scene.splinecode"
      />
      <Content>
        <Menu>
          <li>
        ...
        <p>
          ...
          sharing and storing unilimited media files. A world of topics is
...
const Wrapper = styled.div`
  ...
  .spline {
    ...
    @media (max-width: 800px) {
      trnasform: scale(0.7) translateX(600px);
    }
